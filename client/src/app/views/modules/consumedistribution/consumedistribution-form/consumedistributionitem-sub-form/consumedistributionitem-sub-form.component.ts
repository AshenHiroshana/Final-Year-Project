...
@Component({
  selector: 'app-consumedistributionitem-sub-form',
  templateUrl: './consumedistributionitem-sub-form.component.html',
  styleUrls: ['./consumedistributionitem-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ConsumedistributionitemSubFormComponent),
      multi: true
    }, {
...
export class ConsumedistributionitemSubFormComponent extends AbstractSubFormComponent<Consumedistributionitem> implements OnInit{
