...
@Component({
  selector: 'app-serviceprocurementitem-update-sub-form',
  templateUrl: './serviceprocurementitem-update-sub-form.component.html',
  styleUrls: ['./serviceprocurementitem-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ServiceprocurementitemUpdateSubFormComponent),
      multi: true
    }, {
...
export class ServiceprocurementitemUpdateSubFormComponent extends AbstractSubFormComponent<Serviceprocurementitem> implements OnInit{
