...
@Component({
  selector: 'app-procurementallocationprocurementitem-sub-form',
  templateUrl: './procurementallocationprocurementitem-sub-form.component.html',
  styleUrls: ['./procurementallocationprocurementitem-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ProcurementallocationprocurementitemSubFormComponent),
      multi: true
    }, {
...
export class ProcurementallocationprocurementitemSubFormComponent extends AbstractSubFormComponent<Procurementallocationprocurementitem> implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.allocationstatusField.disable();
  }
  ...
  setValidations(): void{
    ...
    this.allocationstatusField.setValidators([Validators.required]);
  }
  ...
  removeValidations(): void{
    ...
    this.allocationstatusField.clearValidators();
  }
