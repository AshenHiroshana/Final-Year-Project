...
@Component({
  ...
  styleUrls: ['./servicetype-form.component.scss']
})
export class ServicetypeFormComponent extends AbstractComponent implements OnInit {
...
async loadData(): Promise<any>{
  ...
  async submit(): Promise<void> {
    ...
    servicetype.name = this.nameField.value;
    servicetype.vendorList = this.vendorsField.value;
    servicetype.description = this.descriptionField.value;
    try{
      const resourceLink: ResourceLink = await this.servicetypeService.add(servicetype);
