...
@Component({
  selector: 'app-payrolladdition-sub-form',
  templateUrl: './payrolladdition-sub-form.component.html',
  styleUrls: ['./payrolladdition-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => PayrolladditionSubFormComponent),
      multi: true
    }, {
...
export class PayrolladditionSubFormComponent extends AbstractSubFormComponent<Payrolladdition> implements OnInit{
