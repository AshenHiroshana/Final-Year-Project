...
@Component({
  selector: 'app-payrolldeduction-sub-form',
  templateUrl: './payrolldeduction-sub-form.component.html',
  styleUrls: ['./payrolldeduction-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => PayrolldeductionSubFormComponent),
      multi: true
    }, {
...
export class PayrolldeductionSubFormComponent extends AbstractSubFormComponent<Payrolldeduction> implements OnInit{
