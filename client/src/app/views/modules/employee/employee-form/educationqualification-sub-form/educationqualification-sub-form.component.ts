...
@Component({
  selector: 'app-educationqualification-sub-form',
  templateUrl: './educationqualification-sub-form.component.html',
  styleUrls: ['./educationqualification-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => EducationqualificationSubFormComponent),
      multi: true
    }, {
...
export class EducationqualificationSubFormComponent extends AbstractSubFormComponent<Educationqualification> implements OnInit{
