...
@Component({
  selector: 'app-appointmentallowance-update-sub-form',
  templateUrl: './appointmentallowance-update-sub-form.component.html',
  styleUrls: ['./appointmentallowance-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AppointmentallowanceUpdateSubFormComponent),
      multi: true
    }, {
...
export class AppointmentallowanceUpdateSubFormComponent extends AbstractSubFormComponent<Appointmentallowance> implements OnInit{
