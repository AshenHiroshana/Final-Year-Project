...
public class User{
    ...
    @ManyToOne
    @JsonIgnoreProperties({"creator","tocreation","civilstatus","fullname","dobirth","gender","nic","mobile","land","email","address","dorecruit","employeestatus","description","branch","epfno","bankaccountno","bankname","bankbranch","workexperience","educationqualification"})
